...
// CHM - increase allowable angle difference between yaw sensor and desired yaw
#define AC_ATTITUDE_RATE_STAB_YAW_OVERSHOOT_ANGLE_MAX   3000.0f // earth-frame rate stabilize controller's maximum overshoot angle
